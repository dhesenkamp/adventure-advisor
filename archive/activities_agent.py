...
#supabase = psycopg2.connect(SUPABASE_URL)
conn = psycopg2.connect(
    host="db.ovpkmntjpebbfbsnedlq.supabase.co",
    port="5432",
    dbname="postgres",
    user="postgres",
...
#supabase = SQLDatabase.from_connect(conn)
supabase = psycopg2.connect(conn)
...
def prepareAgentPrompt():
    template = """
      ...
      Use the search_activities tool to query the database
